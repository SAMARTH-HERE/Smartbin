...
const garbageCenters = [
    { lat: 20.4625, lng: 85.8828, name: "CDA Garbage Center", email: "samarthgupta316@gmail.com" },
    { lat: 20.4620, lng: 85.8780, name: "Barabati Garbage Center", email: "samarthgupta316@gmail.com" },
    { lat: 20.4543, lng: 85.8822, name: "Cuttack Railway Station Garbage Center", email: "samarthgupta316@gmail.com" },
    { lat: 20.4627, lng: 85.8344, name: "Orissa High Court Garbage Center", email: "samarthgupta316@gmail.com" },
    { lat: 20.4630, lng: 85.8835, name: "Cuttack Medical College Garbage Center", email: "samarthgupta316@gmail.com" },
    { lat: 20.4540, lng: 85.8020, name: "Mahanadi Barrage Garbage Center", email: "samarthgupta316@gmail.com" },
    { lat: 20.4600, lng: 85.8720, name: "Netaji Birth Place Museum Garbage Center", email: "samarthgupta316@gmail.com" },
];
